...
description: Cómo devolver el dinero de una orden y cancelar entradas.
sidebar:
  order: 3
---
...
Los tiempos de acreditación del reembolso dependen de **MercadoPago** y del medio de pago original (puede tardar días hábiles). Avisale eso al comprador.

:::caution
Definí y comunicá tu **política de reembolsos** en los [términos del evento](/evento/configuracion/) antes de vender. Evita malentendidos.
:::
